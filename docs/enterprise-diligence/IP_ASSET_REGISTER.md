...
| API and OpenAPI specification | Software / document | Phillip Wikes | 2026 | **0.1.0-validation; one current public contract** | `openapi.json`; reconciliation record dated 2026-09-22 | Unknown | **Owner assertion** | **COUNSEL DETERMINATION REQUIRED** | None identified | Public | **Unknown** | Technical version conflict resolved 2026-09-22; ownership, licensing and successor-transfer rights remain undetermined pending counsel |
