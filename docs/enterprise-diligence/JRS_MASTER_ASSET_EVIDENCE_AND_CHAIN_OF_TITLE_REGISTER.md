...
| **Ubayet Hossain** | Co-author; methodology | Detection, reliability | E-006 to E-008 | Not located | Not located | Not confirmed | **E-006 to E-008, corroborated by images** | **NOT LOCATED (E-021, targeted search complete)** | Not located | **Authorship corroborated** | **Commercial use and successor transfer — FACTUAL LIMB ANSWERED 2026-09-18 (E-034): approval of the uses discussed is attested, and absence of a stated restriction is attested. AN EXPRESS COMMERCIAL OR LICENSING GRANT IS STILL NOT ESTABLISHED — absence of a prohibition is not a grant. The legal limb stays with B-004; CT-UBAYET is DEFERRED BY OWNER SEQUENCE until publication. The 'Not located' cells in this row are UNCHANGED: an attestation is not a located document** |
