...
| **X-15** | Does referencing an approach that originated in a person's **state-agency employment** carry any third-party interest? | **OPEN — NEW, and it is the question CT-2 becomes.** Not answered here. The approach originated in MCCR intake work. Whether that creates an employer or agency interest is a **legal** question, not an engineering one. **Counsel-adjacent; routed to B-004's channel rather than answered** |
