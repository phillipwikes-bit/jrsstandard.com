...
*Elsevier requires 3 to 5 bullet points, each a single sentence, maximum 85 characters including spaces. Submitted as a separate item in Editorial Manager. Each line below is within the limit (character count in brackets; delete the brackets before submitting).*
