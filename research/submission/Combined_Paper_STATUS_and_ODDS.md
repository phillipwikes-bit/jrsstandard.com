...
**The dominant risk is not peer review; it is completing the gated data.** Today the detection panel is 7 of 24 complete and Arm B has only its first few participants. Until those reach the pre-registered thresholds, the paper cannot be submitted at all. That is the single rate-limiting step.
