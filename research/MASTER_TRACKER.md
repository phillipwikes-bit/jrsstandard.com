...
**Sanya replacement for the Business Ethics / Tanvi paper (2026-07-17): Kyle McMullan (top), Hekim Colpan (alt).** Sanya (compliance/ethics/CFE/investigations) went silent, so her co-author seat on the Business Ethics paper ("Documentation Governance in AI-Assisted Decision-Making," Tanvi HR-compliance pilot) is open. Best Arm A completer match: **Kyle McMullan** (Chief Audit Executive; internal audit & financial crimes; UK/Ireland) - closest to Sanya's investigations/audit/compliance profile, adds a European voice. Alt: Hekim Colpan (compliance/ISO 42001/EU AI Act) - but RESERVE Hekim for the legal Evidentiary-Deficit piece to avoid over-booking. Guardrails: earned authorship only (real writing, not reviewer recognition); one-article-one-author. **NOTE: the CEP article "When the Record Cannot Speak for Itself" is already ACCEPTED as Phillip solo, do NOT add a co-author there now (would need Bill's OK; awkward this late). Open seat is the Business Ethics/Tanvi paper only.**
