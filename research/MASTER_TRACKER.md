...
- **HONEST GAP: none of the 7 completers is an HR professional.** The ideal HR voice for an HR-audience piece + Tanvi's HR pilot is **Dr Nitin Deshpande (V-AI-06), CHRO, 38 yrs HR & industrial relations** - but he is REGISTERED, not a completer (0/24). Co-authorship is earned by writing, not by finishing the review, so Nitin could co-author on HR expertise if willing to write. Decision for Phillip: best completer (Kyle) vs best HR fit (Nitin).
