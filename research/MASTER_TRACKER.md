...
- **Next available comparison code: RR-105.** Assigned 2026-07-13: RR-101 to Boris Khazin (no-JRS/B2), RR-102 to Sundeep Mattaparti (JRS/B1), RR-103 to Pankaj Kumar Bhagat (no-JRS/B2). Assigned 2026-07-14: RR-104 to Donavine Smith (JRS/B1). See Section 12. Batch RR-101 to RR-140 generated (20 land JRS-arm B1, 20 land no-JRS B2); handed out in sequence, never steered. Arm B needs no Supabase token and no `bench_experts` row: just hand out the RR code and the arm-b link.
...
| RR-104 | Donavine Smith, MBA | South Africa (Pretoria) | JRS (B1) | Invited 2026-07-14; JRS-naive per Arm B direction (**CONFIRM she has not engaged with JRS content; if she has, route to Panel instead**). Chief Strategy / Transformation Officer; frontier AI strategy & governance; NED, Rape Crisis Cape Town Trust. Code lands in B1 by the deterministic hash, not by selection. Arms now balanced 2/2 (B1: RR-102, RR-104; B2: RR-101, RR-103) |
