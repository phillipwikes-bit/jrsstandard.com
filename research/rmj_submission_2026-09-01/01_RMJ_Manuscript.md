...
**Purpose.** Records are judged, on appeal and in audit, on whether a reader who was not there can rebuild the basis for the decision from the record itself. Nothing measures that property directly. This paper tests whether a structured, record-level read can.
...
**Keywords.** Records management; information governance; documentation quality; public records; freedom of information; recordkeeping evidence
...
Compliance audits: New York State Comptroller, compliance with Freedom of Information Law requirements (2020, 2021, 2023); New York City Comptroller, Review of the New York City Police Department's Body-Worn Camera Program (2025).
