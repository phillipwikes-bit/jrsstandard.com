...
Across 15 constructed records, three independent vendor models reached a mean pairwise agreement of **87.8 percent** on the determination on the most recent nightly run (2026-08-12). Fifty-five cross-vendor runs are on record between 13 June and 12 August 2026, with a mean of 84.5 percent, a median of 85.6 percent, and a range of 66.7 to 93.3 percent. Runs early in the series scored a smaller record set as the corpus grew, so the run-to-run figures are not on a constant denominator and the series is reported as a range rather than as a trend. This indicates consistent application at machine level and is explicitly not a measure of correctness.
...
**3. Cross-vendor reproducibility corrected.** The draft carried 84 percent from a run dated 2026-07-06, with a band of 78 to 87 percent. The current figure is **87.8 percent** from 2026-08-12. Fifty-five cross-vendor runs are on record with a mean of 84.5, a median of 85.6 and a range of 66.7 to 93.3. The draft's band understated the spread. Added: early runs scored fewer records as the corpus grew, so the series is not on a constant denominator, which the draft did not say.
