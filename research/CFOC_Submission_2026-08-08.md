...
The submission to Dr. Frazier offers the protocol, the case set and the analysis without charge. That is the right posture: the asset here is the category and the evidence base, and a federal inventory citing the work is worth considerably more than a licence fee from a single agency.
