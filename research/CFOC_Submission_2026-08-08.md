...
A fourth check found no relationship between the read and whether an agency prevailed on appeal, and the study reports that plainly. Published cases are selected for contested legal questions rather than thin files, which is why audit findings, and not appellate outcomes, are the measure a records programme can act on. That reading has since been tested. The same instrument applied in a second domain, employment and labour matters, on 22 adjudicated cases that are not filtered by publication practice, does show the association: records assessed as complete were sustained in six of eight resolved cases against one of eight for records assessed as incomplete, p = 0.041.
