...
**Hekim Colpan** is an AI Governance and Compliance Manager and an ISO/IEC 42001 auditor, based in Germany. His work centers on making AI governance and compliance operational for regulated organizations, including EU AI Act conformity, GDPR accountability, and DORA obligations for AI-assisted systems, with particular attention to how record-keeping, logging, and technical-documentation requirements land in day-to-day practice. *(Bio to be confirmed and adjusted by Hekim before submission; use only titles and affiliations he verifies himself.)*
