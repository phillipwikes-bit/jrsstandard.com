...
*Draft prepared for Hekim Colpan's review as prospective lead co-author. Content is open to his revision; the governance and EU-frame sections (V, VI, VIII) are his to shape. Nothing here should run under his name until he has reviewed and confirmed it.*
...
One of us has spent a career inside European AI governance and compliance, assessing how organizations document and defend automated and AI-assisted processing against ISO/IEC 42001, the EU AI Act, and the GDPR. The other spent more than a decade reading consequential records after the fact, for a United States civil rights agency, and saw the same pattern repeat: the decision was often sound, and the record could not show why. From both vantage points the conclusion is the same. As AI drafts more of the documents behind consequential decisions, the evidence that would let anyone reconstruct those decisions is quietly disappearing.
...
**Hekim Colpan** is an AI Governance and Compliance Manager and an ISO/IEC 42001 auditor, based in Germany. His work centers on operationalizing AI governance and compliance for regulated organizations, including EU AI Act conformity, GDPR accountability, and DORA obligations for AI-assisted systems, with a focus on how record-keeping, logging, and technical-documentation requirements apply to automated and AI-assisted processing in practice. *(Bio to be confirmed and adjusted by Hekim before submission; use only titles and affiliations he verifies himself.)*
