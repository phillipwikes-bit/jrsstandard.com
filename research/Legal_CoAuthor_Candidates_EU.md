# EU AI-law co-author candidates (peers of Dr. Gabriela Bar)

*Prepared 2026-07-30. Purpose: replacement lead author for the legal article "The Evidentiary Deficit in AI-Assisted Record-Keeping" after Dr. Gabriela Bar declined co-authorship (2026-07-30). These are real, public, peer-tier European women lawyers/scholars in AI law, data protection, and algorithmic accountability. One-line descriptors are conservative; VERIFY current title, firm, and jurisdiction from each person's own site/LinkedIn before outreach (no fabricated accolades). One-article-one-author rule: approach ONE at a time. Outreach must sell the article on its merits.*

| # | Candidate | Base | Standing / fit |
|---|---|---|---|
| 1 | Prof. Lokke Moerel | Netherlands | Global ICT Law prof. (Tilburg); senior counsel, Morrison Foerster; former Dutch Cyber Security Council; GDPR + AI accountability. |
| 2 | Prof. Sandra Wachter | UK / Austria | Prof., Oxford Internet Institute; "right to explanation," algorithmic accountability and transparency. Directly on-theme. |
