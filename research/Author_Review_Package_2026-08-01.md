...
One change since we last spoke: the reviewer reliability result is now reported as preliminary and not yet final. The reviewer sample is still accumulating toward the pre-registered pooled target, and rather than report a coefficient on an underpowered set, the manuscript states that the reliability analysis, and its pre-registered floor test, will be reported when the sample is complete. The methodology you designed is unchanged and stands as described; only the timing of the reported result has moved. I want your sign-off that the methods text represents your framework accurately.
