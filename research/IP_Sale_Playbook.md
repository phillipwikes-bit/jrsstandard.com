...
- A finished investigator Field Guide product line (EEO, Fair Housing, International), favorably mentioned by Dewey Publications in two separate, verified places: (a) in writing in the _News and Case Alert_ (Issue #18-07, July 10 2026, author Peter Broida): a datable, quotable third-party mention; and (b) on the Dewey Publications Podcast, episode "July 6th, 2026" (host Peter Broida), which discusses JRS and lists it in the episode notes under "Resources for investigators." Neither is an endorsement. Both are now cited in buyer-facing materials. Quote the newsletter from its text; cite the podcast by its episode notes only (no timestamp, no transcript claim: the published episode runs 18 minutes, so the earlier 23:45 reference cannot be correct).
